...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const I18N = {
    id: {
      ...
      'trust.label': 'Terakreditasi & Diakui', 'trust.1': 'Akreditasi A', 'trust.2': 'Madrasah Negeri', 'trust.3': 'Kurikulum Merdeka', 'trust.1s': 'BAN-S/M', 'trust.2s': 'Kementerian Agama RI', 'trust.3s': 'Piloting nasional', 'trust.5': 'Boarding School',
    ...
    en: {
      ...
      'trust.label': 'Accredited & Recognized', 'trust.1': 'Accreditation A', 'trust.2': 'Public Madrasah', 'trust.3': 'Kurikulum Merdeka', 'trust.1s': 'BAN-S/M', 'trust.2s': 'Ministry of Religious Affairs', 'trust.3s': 'National pilot', 'trust.5': 'Boarding School',
